...
function rowOfLeafNodes(number, empty = false) {
    //   let leaves = getNextPowerOfTwo(number);
    let row = [];
    if (number % 2 == 0) {
      for (let i = 0; i < number; i++) {
        row.push(
          <div key={`leafNodes${i}`} className="d-flex flex-row justify-content-evenly">
  ...
  function displayTreeNodes(number, empty = false) {
    ...
    if (number == 2) {
        for (let i = 0; i < number; i += 2) {
            row.push(
              <div key={`treenodes${i}`} className="d-flex flex-row justify-content-evenly">
                <div className="d-flex flex-col">
                  <h4>{`hash (`} </h4>
                </div>
                <div className="d-flex flex-col p-1">
        ...
        _tree = []
            _tree.push(
              ...
              >
                ...
                <div className="col p-1 align-items-center">
                  <Node type="1" level="demo" style={{ color: "gold" }} />
                </div>
       ...
       _tree = []
        ...
        _tree = [];
          ...
          for (let i = 0; i < leaves; i += 2) {
              _tree.push(
                <div key={`branchnodes${i}`} className="d-flex flex-row justify-content-evenly">
                  <div className="d-flex flex-col">
                    <h4>{`hash (`} </h4>
                  </div>
                  <div className="d-flex flex-col p-1">
          ...
          _tree.push(
            <div key={`leafnodes 0${i}`} className="d-flex flex-row justify-content-evenly">
              <div className="d-flex flex-col">
                <h4>{`hash (`} </h4>
              </div>
              <div className="d-flex flex-col p-1">
        ...
        _tree.push(
          ...
          for (let i = 0; i < leaves; i += 2) {
              _tree.push(
                <div key={`branchnodes 0${i}`} className="d-flex flex-row justify-content-evenly">
                  <div className="d-flex flex-col">
                    <h4>{`hash (`} </h4>
                  </div>
                  <div className="d-flex flex-col p-1">
          ...
          _tree.push(
            <div key={`leaf nodes 1${i}`} className="d-flex flex-row justify-content-evenly">
              <div className="d-flex flex-col">
                <h4>{`hash (`} </h4>
              </div>
              <div className="d-flex flex-col p-1">
